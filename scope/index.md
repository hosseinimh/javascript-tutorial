...
<div dir="rtl">
سطح در دسترس متغیرها را تعیین می‌کند. در واقع scope؛ execution context فعلی است که نشان می‌دهد در حال حاضر کدام متغیرها، توابع و اشیا قابل دسترسند. Scope ها سلسله‌مراتبی‌اند به طوری که scope فرزند به scope والد دسترسی دارد اما عکس آن نه.
</div>
...
<br/>
اگر ماژول دیگری بخواهد از متغیر، تابع یا شی ماژول فعلی استفاده کند باید آن را export کرده و در ماژول دیگر آن را import کنیم:
</div>
